...
- If upstream advances without bumping its package version and that fork version already exists on npm, increment the fork suffix instead of reusing an immutable version: published `0.6.1-1` -> fork `0.6.1-2`.
