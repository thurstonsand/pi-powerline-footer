import { getAgentDir, copyToClipboard, type ExtensionAPI, type ExtensionContext, type ReadonlyFooterDataProvider, type Theme } from "@mariozechner/pi-coding-agent";
